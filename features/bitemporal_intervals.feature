Feature: Bitemporal intervals
  ...
  Scenario: virkningTid negative and zero
    ...
    And the database table status_report should contain rows with the following entries
      | file_extract_id | table_name | total_rows | non_positive_interval_registrering | non_positive_interval_virkning | bitemporal_data_integrity_count | bitemporal_data_integrity_instances | bitemporal_data_integrity_objects |
      | 1               | Postnummer | 3          | 0                                  | 2                              | 0                               | 0                                   | 0                                 |
