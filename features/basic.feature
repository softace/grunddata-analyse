Feature: Basic stuff
  ...
  Scenario: Loading the initial load
    ...
    Given the file extract contains data for Postnummer with dummy data and
      ...
      | guid-A-1   | 2020-01-01T01:01:01.111111+01:00 |                 | 2020-01-01T01:01:01.111111+01:00 | 2020-01-02T01:01:01.111111+01:00 |
    ...
    Given the file extract contains data for Grund with dummy data and
      | id_lokalId | registreringFra                  | registreringTil | virkningFra                      | virkningTil                      |
      | guid-B-1   | 2020-01-01T01:01:01.111111+01:00 |                 | 2020-01-01T01:01:01.111111+01:00 | 2020-01-02T01:01:01.111111+01:00 |
    When file extract is loaded in the DAF database
    ...
    Given the file extract contains data for Ejerlav with dummy data and
      ...
      | guid-C-1   | 2020-01-01T01:01:01.111111+01:00 |                 | 2020-01-01T01:01:01.111111+01:00 | 2020-01-02T01:01:01.111111+01:00 | Gældende |
    When file extract is loaded in the DAF database
    Then the database table Ejerlav should contain rows with the following entries
      | id_lokalId | registreringFra                  | registreringTil | virkningFra                      | virkningTil                      | status   |
      | guid-C-1   | 2020-01-01T01:01:01.111111+01:00 |                 | 2020-01-01T01:01:01.111111+01:00 | 2020-01-02T01:01:01.111111+01:00 | Gældende |
