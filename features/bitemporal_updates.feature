Feature: Bitemporal data integrity
  ...
  Scenario: Finalising an already final instance should update and log violation
    ...
    Then the database table violation_log should contain rows with the following entries and no more:
      | table_name | id_lokalId | registreringFra_UTC              | virkningFra_UTC                  | violation_type                | violation_text                                                                         |
      | Postnummer | guid-1     | 2020-01-01T00:01:01.111111+00:00 | 2020-01-01T00:01:01.111111+00:00 | Ugyldig opdatering af værdier | (registreringTil) opdateret. Tidligere værdi(er): ('2020-01-02T01:01:01.111111+01:00') |
